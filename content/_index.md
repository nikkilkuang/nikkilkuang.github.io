...
sections:
  ...
  - block: markdown
    ...
    content:
      title: Invited Talks
      text: <ul>
            <li>Inference-time Alignment for Personalized LLMs
              <ul>
            ...
            <li>Efficient Langevin Thompson Sampling in Bandits and RL
              <ul>
                <li>HDSI Industry Research Review, 2023</li>
              </ul>
            </li>
            <li>Batched Approximate Thompson Sampling
              <ul>
                <li>TILOS AI Institute Trainee Workshop, 2022</li>
              </ul>
            </li>
        </ul> 
    design:
    ...
    content:
      ...
      text: <ul>
          <li><strong>Conference Reviewers</strong>
            <ul>
              <li>NeurIPS (<em>2023 - </em>)</li>
              <li>AISTATS (<em>2023 - </em>)</li>
              <li>AAAI (<em>2023 - </em>)</li>
              <li>ICML (<em>2024 - </em>)</li>
              <li>ICLR (<em>2024 - </em>)</li>
